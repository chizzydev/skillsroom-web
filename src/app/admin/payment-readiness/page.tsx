...
export default async function AdminPaymentReadinessPage() {
  ...
  const [
    ...
    listFundingSubmissions("submitted", 25),
    listFundingSubmissions("approved", 12),
    listFundingSubmissions("rejected", 12),
    listWalletTopups("submitted", 25),
    listWalletTopups("approved", 12),
    listWalletTopups("rejected", 12),
    listWalletPayoutRequests("requested", 25),
    listWalletPayoutRequests("paid", 12),
    listWalletPayoutRequests("rejected", 12),
    listPayouts("queued", 25),
    listPayouts("completed", 12),
    listPayouts("failed", 12),
    listRefunds("queued", 25),
    listRefunds("completed", 12),
    listRefunds("failed", 12),
    listTournamentPayouts("queued", 25),
    listTournamentPayouts("completed", 12),
    listTournamentPayouts("failed", 12),
    listTournamentRefunds("queued", 25),
    listTournamentRefunds("completed", 12),
    listTournamentRefunds("failed", 12),
    getAdminWalletDashboard({ limit: 50 })
  ]);
