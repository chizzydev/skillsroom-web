...
export function StatusPanel({ label, value, tone, detail }: StatusPanelProps) {
  return (
    <div className="motion-card relative min-w-0 overflow-hidden rounded-[1.2rem] border border-line bg-white px-4 py-4 shadow-[0_16px_40px_rgba(3,10,20,0.08)] sm:px-5">
