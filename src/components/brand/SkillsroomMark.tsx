type SkillsroomMarkProps = {
  className?: string;
  muted?: boolean;
};

export function SkillsroomMark({ className = "", muted = false }: SkillsroomMarkProps) {
  const ring = muted ? "#CBD5E1" : "#23D8B0";
  const fill = muted ? "#0F172A" : "#0B1324";
  const accent = muted ? "#E2E8F0" : "#E9FFF8";
  ...
  return (
    ...
    >
      <rect fill={fill} height="64" rx="18" width="64" />
      <path
      ...
      />
      <path
        d="M35 34H40.75C41.4404 34 42 34.5596 42 35.25C42 35.9404 41.4404 36.5 40.75 36.5H35C34.3096 36.5 33.75 35.9404 33.75 35.25C33.75 34.5596 34.3096 34 35 34Z"
        fill={fill}
      />
      <path
        d="M35 39.5H40.75C41.4404 39.5 42 40.0596 42 40.75C42 41.4404 41.4404 42 40.75 42H35C34.3096 42 33.75 41.4404 33.75 40.75C33.75 40.0596 34.3096 39.5 35 39.5Z"
        fill={fill}
      />
    </svg>
  );
